...
export const log = {
   ...
   */
  request: (method: string, endpoint: string, statusCode: number, duration: number, requestId: string) => {
   ...
   * Log security events
   */
  security: (event: string, severity: 'low' | 'medium' | 'high' | 'critical' = 'medium', context?: LogContext) => {
